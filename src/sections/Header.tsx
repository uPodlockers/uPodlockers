...
import Logo from '@/assets/logo-upod.png';
          ...
          <div className="container">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Image src={Logo} alt="uPOD Logo" height={150} width={150} />
                {/* <span className="font-bold text-lg">upod</span> */}
              </div>

              <MenuIcon className="h-5 w-5 md:hidden" />
              
              <nav className="hidden md:flex gap-6 font-semibold text-black/100 items-center">
                <a href="#">Home</a>
                <a href="#">Products</a>
                <a href="#">Solutions</a>
                <a href="#">Company</a>
